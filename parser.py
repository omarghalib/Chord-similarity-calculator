...
def update_dict_with_similarity_scores(songs_dict, list_of_chord_sets):
  ...
  for chord_set in list_of_chord_sets:
    ...
    for other_chord_set in list_of_chord_sets[other_song_id:]:
      ...
      songs_dict[song_id]["similarityScores"][other_song_id] = {"score": similarity_score, "songId": other_song_id}
      songs_dict[other_song_id]["similarityScores"][song_id] = {"score": similarity_score, "songId": song_id}
